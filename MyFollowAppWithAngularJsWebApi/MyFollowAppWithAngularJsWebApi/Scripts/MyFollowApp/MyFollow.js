...
app.controller('ExternalLoginController', function ($http, $scope, $window,$location) {
    ...
    $scope.authExternalProvider = function (provider) {
        debugger;
        var externalProviderURL = "https://localhost:44335/api/Account/ExternalLogin?provider=" + provider + "&response_type=token&client_id=self&redirect_uri=https%3A%2F%2Flocalhost%3A44364%2FAccount%2FLogin&state=CQUnoseuk8DEW-81NWQrvVfU9ZEt7vH-knEBRNNOGAQ1";
...
app.controller("ProductDetailsController", function ($scope, $timeout, $location, $rootScope, $window, $http, FileUploadService) {
    ...
    .factory('FileUploadService', function ($http, $q) {
        ...
        fac.UploadFile = function (file,id) {
            ...
            var defer = $q.defer();
            $http.post("MediaDetailsApi/UploadFile/" + id, formData,
                {
